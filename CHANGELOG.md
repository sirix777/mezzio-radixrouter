...
### Added
- Comprehensive benchmark suite comparing RadixRouter with FastRoute and LaminasRouter (in `benchmark-comparison/`)
- Benchmark results and documentation section in main `README.md`
